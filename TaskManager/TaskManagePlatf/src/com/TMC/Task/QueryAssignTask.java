...
public class QueryAssignTask extends QueueRunnable{

	private long timestamp;
	private TASK_STATUS status;
	private UserInfoPojo userInfoModel;
	public QueryAssignTask(UserInfoPojo userInfoModel, TASK_STATUS stauts, long timestamp,CellBack cellBack) {
		this.timestamp = timestamp;
		this.status = stauts;
		this.userInfoModel = userInfoModel;
		this.setCellBack(cellBack);
		this.setName("定时获取我的任务");
	...
	public void doTask() {
		try {
			...
			message.setMethod(Message.QUERY_MY_TASK);
