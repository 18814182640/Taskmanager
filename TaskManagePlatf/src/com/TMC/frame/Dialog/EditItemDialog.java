...
public class EditItemDialog extends Dialog {
	 ...
	 */
	public EditItemDialog(Shell parent,ItemInfoPojo itemInfoPojo) {
		super(parent);
	...
	public TaskModel open() {
		...
		fd_label_2.bottom = new FormAttachment(okButton, -105);
		fd_label_2.left = new FormAttachment(0, 10);
		label_2.setLayoutData(fd_label_2);
		
		text = new Text(composite, SWT.BORDER);
		FormData fd_text = new FormData();
		fd_text.bottom = new FormAttachment(okButton, -101);
		...
		fd_label.bottom = new FormAttachment(okButton, -68);
		...
		fd_text_1.bottom = new FormAttachment(okButton, -63);
		...
		fd_label_1.bottom = new FormAttachment(okButton, -31);
		...
		fd_combo.bottom = new FormAttachment(okButton, -26);
		...
		fd_lblid.left = new FormAttachment(label_2, 0, SWT.LEFT);
		lblid.setLayoutData(fd_lblid);
		
		text_2 = new Text(composite, SWT.BORDER);
		text_2.setEditable(false);
		FormData fd_text_2 = new FormData();
		fd_text_2.left = new FormAttachment(text, -378);
		fd_text_2.bottom = new FormAttachment(text, -9);
		fd_text_2.right = new FormAttachment(text, 0, SWT.RIGHT);
		text_2.setLayoutData(fd_text_2);
		
		
		text_2.setText(itemInfoPojo.getId()+"");
		text.setText(itemInfoPojo.getItemName()+"");
		text_1.setText(itemInfoPojo.getExplain());
		combo.select(itemInfoPojo.getDepartment_id()-1);
